...
(custom-set-variables
 ...
 '(package-selected-packages
   '(avy counsel d-mode dash evil geiser-guile glsl-mode gnuplot
	 gnuplot-mode god-mode j-mode magit mini-modeline monkeytype
	 org-contrib paredit rust-mode scala-mode sly smalltalk-mode
	 titan-mode tramp typetest which-key))
